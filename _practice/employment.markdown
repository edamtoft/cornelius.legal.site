...
identifier: CivlLaw
layout: page
description_text: When you need to talk with a lawyer- about unpaid wages, about your
  landlord, about a contract, about a lawsuit you want to bring- call me and make
  an appointment.
language: english
icon: bank
